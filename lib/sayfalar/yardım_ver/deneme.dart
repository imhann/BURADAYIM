...
class YardimVerDeneme extends StatefulWidget {
  KisiModel kisiModel;
  ...
  @override
  State<YardimVerDeneme> createState() => _YardimVerDenemeState();
}

class _YardimVerDenemeState extends State<YardimVerDeneme> {
  //Veri tabanını çağır
        ...
        ElevatedButton(
          ...
          onPressed: () async {
            ...
            if (listeUrun!.isNotEmpty) {
              ...
              Navigator.of(context).pushAndRemoveUntil(
                  MaterialPageRoute(
                    builder: (context) => YardimVerDeneme(
                      kisiModel: widget.kisiModel,
